...
public class DriverSignInActivity extends AppCompatActivity {
    ...
    private boolean validateName(){
        ...
        if(nameInput.isEmpty()){
            ...
            textInputName.setError("Name length have to be les then 15");
            return false;
        }
        else {
    ...
    private boolean validatePassword(){
        ...
        if(passwordInput.isEmpty()){
            ...
            textInputPassword.setError("Name length have to be more then six");
            return false;
        }else {
    ...
    public void loginSignUpUser(View view) {
        ...
        loginUser(textInputEmail.getEditText().getText().toString().trim(), textInputPassword.getEditText().getText().toString().trim());
