...
public class PassengerMapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void signOutPassenger() {
        ...
        DatabaseReference passengers = FirebaseDatabase.getInstance().getReference().child("passenger");
                ...
                new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        ...
                        if (ActivityCompat.checkSelfPermission(PassengerMapsActivity.this,
                                Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(PassengerMapsActivity.this,
                        ...
                        switch (statusCode){
                            case LocationSettingsStatusCodes
                                ...
                                try {// показываем пользователю окно в котором будем запрашивать разрешение
                                    ...
                                    resolvableApiException.startResolutionForResult(PassengerMapsActivity.this,CHECK_SETTINGS_CODE ); // нужно получать результат  (по коду)
